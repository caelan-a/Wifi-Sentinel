							...
							<table>
								...
								<tbody>
									...
									foreach ($devices as $d) {
										...
										echo "<tr>";
										if($known) {
											echo '<td><i class="fas fa-check-circle" style="font-size: 2em; padding-top:20px; color:#42f551; "></i></td>';
										} else {
											echo '<td><i class="fas fa-exclamation-triangle" style="font-size: 2em; padding-top:20px; color:#ff6700; "></i></i></td>';

										}
										echo '<td><p>' . $d[7] . '</p></td>';
										echo '<td><p>' . $d[0] . '</p></td>';
										echo '<td><p>' . $first_seen->format('g:ia') . ' | '. $first_seen->format('jS M Y') . '</p></td>';
										echo '<td><p>' . $last_seen->format('g:ia') . ' | '. $last_seen->format('jS M Y') . '</p></td>';
										echo '<td><p>' . $d[3] . '</p></td>';
										echo '</tr>';
									}
